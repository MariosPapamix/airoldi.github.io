...
html_4 <- 
  paste0('<p style="text-align: center; margin-top: 40px;"><small>Last updated <i>',
         ...
         '&ndash; Pulled automatically from my <a href="https://scholar.google.com/citations?hl=en&user=b8bWNkUAAAAJ">Google Scholar profile</a>.</i></small></p>', html_3, collapse="")

# write the html list to a file
writeLines(html_4, "/Volumes/Data/GitHub/airoldi.github.io/src/html4-v2.html")
